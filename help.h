...
static struct argp_option optionsReadsb[] = {
    ...
    {"net-asterix-out-port", OptNetAsterixOutPorts, "<ports>", 0, "TCP Asterix output listen ports (default: 0)", 2},
    {"net-asterix-in-port", OptNetAsterixInPorts, "<ports>", 0, "TCP Asterix input listen ports (default: 0)", 2},
    ...
    {"net-json-port", OptNetJsonPorts, "<ports>", 0, "TCP json position output listen ports, sends one line with a json object containing aircraft details for every position received (default: 0) (consider raising --net-ro-size to 8192 for less fragmentation if this is a concern)", 2},
